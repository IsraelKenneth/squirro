...
// import { Squirro1, Squirro2 } from '../assets';
// import SectionHeader from './SectionHeader';


// const data = [
//   {
//     title: "1. Retrieval Augmented Generation (RAG) Explained",
//     image: image1,
...
// const BentoCarousel = ({title, svg, description, description2, description3, description4}) =>{
//   return(
//     <div className="relative border mt-16  p-7 rounded-xl bg-white dark:bg-gray-700 drop-shadow-md border-neutral-200/50 lg:w-full lg:h-[32rem] flex lg:flex-row flex-col gap-y-10 justify-start">
//           <div
//         className='absolute  z-2 left-6 flex space-x-2 bg-gray-300 text-gray-900 border-gray-200 shadow-2xl -mt-14 w-14 h-12 px-2 py-2 rounded-md items-center justify-center border-neutral-200/50'
//       >
//         {svg}
//       </div>
//     <div className='w-full flex relative flex-col justify-start gap-6'>
//      <div className="flex flex-col gap-6">
//      <p className="font-bold text-lg">{title}</p>
//      <p className="font-medium text-[0.9rem] text-slate-700/90 dark:text-gray-300">{description}</p>
//      </div>
//      <div className="flex flex-col gap-6">
//      <p className="font-medium text-[0.9rem] text-slate-700/90 dark:text-gray-300">{description2}</p>
//      <p className="font-medium text-[0.9rem] text-slate-700/90 dark:text-gray-300">{description3}</p>
//      <p className="font-medium text-[0.9rem] text-slate-700/90 dark:text-gray-300">{description4}</p>
//      </div>
//    </div>
//    <div className='w-full h-full flex relative justify-center '>
//    <img src={Squirro2} className='object-contain'/>
//    </div>
//    </div>
//   )
// }
...
//           brief="The first enterprise-ready Retrieval Augmented Generation (RAG) stack and Large Language Model (LLM) offering. SquirroGPT enables enterprises to benefit from safe and versatile Generative AI usage and is LLM agnostic."
//           />
//     <Swiper
//     slidesPerView={'auto'}
//     centeredSlides={true}
...
const WhyLove = () => {
  ...
  const closeDropdown = (event) => {
    if (!dropdownButtonRef.current.contains(event.target) && !dropdownMenuRef.current.contains(event.target)) {
